...
handlerFile = RotatingFileHandler("log/enlaces.log", maxBytes=5e+6, backupCount=5)
handlerFile.setFormatter(formatter)
handlerFile.setLevel(logging.DEBUG)
logger.addHandler(handlerFile)

handlerFileError = RotatingFileHandler("log/enlacesError.log", maxBytes=5e+6, backupCount=5)
